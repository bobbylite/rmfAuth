...
var PersistentConnection = (function () {
    function PersistentConnection(settings) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if ((method === 'GET') && (options.key === '')) {
                        ...
                        return [2, this.patch(bucket, options.key, options.data)];
                    }
        ...
        this.patch = function (bucket, key, patch) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2, new Promise(function (resolve, reject) {
                            _this.addRequest({ op: 'patch', bucket: bucket, key: key, patch: patch }, function (err, result) {
                                if (err) {
